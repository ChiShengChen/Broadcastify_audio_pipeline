...
# 测试 gpt-oss-20b 在 pipeline 中的集成

echo "=== Testing gpt-oss-20b Integration with Custom Parameters ==="
...
./run_llm_pipeline.sh \
    ...
    --output_dir "/media/meow/One Touch/ems_call/test_pipeline_gpt_oss_20b" \
